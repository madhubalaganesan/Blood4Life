...
<header class="bgimg-1 w3-display-container">
  ...
  <div class="w3-display-left w3-padding w3-row w3-third l6 m8" style="margin-left:50px;">
    ...
    <div class="w3-container w3-red">
      <h3><i class="fa fa-refresh w3-margin-right"></i>Reschedule Appointment</h3>
    </div>
      ...
      <form action="/index.php" target="_blank">
        <div class="w3-row-padding" style="margin:0 -16px;">
          <div class="w3-margin-bottom">
            ...
            <input class="w3-input w3-border w3-round-xlarge" type="date" placeholder="Select a Date" name="newDate" required>
          </div>
          <div>
            <label>Select a Time</label>
            <input class="w3-input w3-border w3-round-xlarge" type="time" placeholder="Select a Time" name="newTime" required>
          </div><br>
          <div>
        ...
        <div class="w3-row">
         <div class="w3-col" style="width:100%; text-align: center; padding-top:10px;">
                <button class="w3-button w3-red w3-round-xlarge" type="submit"><i class="fa fa-check-square-o w3-margin-right"></i>Submit</button>
         </div>
</div>
      </form>
    </div>
